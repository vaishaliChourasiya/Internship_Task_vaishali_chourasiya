...
public class Result extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int s= (int) session.getAttribute("sc");
		out.print(s);
		  out.println("<!DOCTYPE html>");
	        ...
	        out.println("<p class='result-score'>Your Score: <span class='text-success'>" + s + "</span> out of 5</p>");
	        out.println("<a href='Home.html' class='btn btn-primary btn-block'>Back to Quiz</a>");
	        out.println("</div>");
